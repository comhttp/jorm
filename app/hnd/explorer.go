...
//
//	lastblock := nodes.RPCSRC(v["coin"]).GetBlockCount()
//	lb := map[string]interface{}{
//		"currentPage": page,
//		"pageCount":   nodes.RPCSRC(v["coin"]).GetBlockCount() / per,
//		"blocks":      nodes.RPCSRC(v["coin"]).GetBlocks(per, page),
//		"lastBlock":   lastblock,
//	}
//
...
//	if err != nil {
//		block = (nodes.RPCSRC(v["coin"]).GetBlock(v["id"])).(map[string]interface{})
//	} else {
//		block = nodes.RPCSRC(v["coin"]).GetBlockByHeight(int(id))
//	}
...
//	block := nodes.RPCSRC(v["coin"]).GetBlockByHeight(bhi)
//	out, err := json.Marshal(block)
//	if err != nil {
//		fmt.Println("Error encoding JSON")
//		return
...
//	v := mux.Vars(r)
//	bh := v["blockhash"]
//	block := (nodes.RPCSRC(v["coin"]).GetBlock(bh)).(map[string]interface{})
...
//	// node := Node{}
//
//	tx := nodes.RPCSRC(v["coin"]).GetTx(txid)
//
...
//	v := mux.Vars(r)
//	rawMemPool := nodes.RPCSRC(v["coin"]).GetRawMemPool()
...
//	v := mux.Vars(r)
//	miningInfo := nodes.RPCSRC(v["coin"]).GetMiningInfo()
//
...
//	v := mux.Vars(r)
//	info := nodes.RPCSRC(v["coin"]).GetInfo()
...
//	v := mux.Vars(r)
//	info := nodes.RPCSRC(v["coin"]).GetPeerInfo()
//	out, err := json.Marshal(info)
//	if err != nil {
//		fmt.Println("Error encoding JSON")
//		return
