...
func (b *BitNode) APIGetRawMemPool() interface{} {
	...
	if err != nil {
		log.Println("Jorm Node Get Raw Mem Pool Error", err)
	}
	return get
}
...
func (b *BitNode) APIGetMiningInfo() interface{} {
	...
	if err != nil {
		log.Println("Jorm Node Get Mining Info Error", err)
	}
	return get
}
...
func (b *BitNode) APIGetNetworkInfo() interface{} {
	...
	if err != nil {
		log.Println("Jorm Node Get Network Info Error", err)
	}
	return get
}
...
func (b *BitNode) APIGetInfo() interface{} {
	...
	if err != nil {
		log.Println("Jorm Node Get Info Error", err)
	}
	return get
}
...
func (b *BitNode) APIGetPeerInfo() interface{} {
	...
	if err != nil {
		log.Println("Jorm Node Get Peer Info Error", err)
	}
	return get
}
